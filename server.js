...
app.post('/lead', async (req, res) => {
  ...
  try {
    ...
    const callButton = phone ? `<a href="tel:${phone.replace(/\D/g,'')}" style="display:inline-block;background:#16a34a;color:white;padding:14px 28px;border-radius:99px;font-family:sans-serif;font-size:15px;font-weight:700;text-decoration:none;margin:16px 0;">📞 Call ${name ? name.split(' ')[0] : 'them'} now</a>` : '';
